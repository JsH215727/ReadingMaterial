...
public class Novel extends ReadingMaterials {
	...
	public Novel(int seriesNum, String seriesName){
		...
		setAuthor("Jill Kelly");
		setTitle("Adventures of Harry");
		setPublisher("Publishing Clearing House");
		setPages(400);
	}
	@Override
	public String toString() {
		return "Novel [Series Name="+seriesName+"Series Number="+seriesNum+"numberOfPg=" + numberOfPg + ", author=" + author + ", publisher=" + publisher
				+ ", title=" + title + "]";
	}
